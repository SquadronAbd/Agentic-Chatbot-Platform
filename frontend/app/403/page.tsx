      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-5 py-10">
        ...
        >
          <GlassCard className="p-10 text-center shadow-glass">
            <div className="mx-auto mb-6 grid h-20 w-20 place-items-center rounded-3xl bg-gradient-to-br from-iris/25 to-rose-500/20 shadow-glow-iris">
              <Shield className="h-10 w-10 text-rose-400" />
            </div>
            <p className="mb-2 font-display text-6xl font-black tracking-tight bg-gradient-to-br from-iris-light via-aqua to-iris bg-clip-text text-transparent">
              403
            </p>
